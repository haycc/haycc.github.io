...
while true; do
    ...
    case $nsewuh in
        ...
        s ) echo "Such green. Much bad. Go back." ;;
        e ) ./mainroom.sh
            exit ;;
        w ) echo "You attempt to go west, but ALL YOU SEE IS GREEN." ;;
		u ) echo "You think about using the color green, but realise it's not possible." ;;
		h ) echo "You curl yourself up into a ball and rock back and forth, as you hug your self" ;;
