...
echo "seem to be rendered more speechless than a test dummy."
echo
sleep 5
echo
echo "A waiter brings out a tray and places it in front of you. Lifting the lid,"
echo "you find a weird rainbow coloured apple in front of you. Very odd, you think"
echo "to yourself. What does this mean? Are you supposed to eat the apple?"
echo "Is this some kind of test? Who ARE these people?!"
echo
sleep 5
echo
