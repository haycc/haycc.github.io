...
echo
sleep 1
echo "You eat the apple, and suddenly rainbows are all around you."
echo
sleep 4
...
echo
sleep 7
echo "Your phone buzzes. It's a call from a number you dont know. You don't usually"
...
echo "but the aim was to have fun with coding, not win a prize."
echo
echo "                                                                - Hayden Cahoon"
echo
