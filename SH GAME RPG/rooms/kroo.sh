...
echo "you to another mysterious room. This is getting a bit weird..."
sleep 3
echo "actually it's a lot weird"
echo
echo "You now seem to find yourself in a small corridor. You can"
