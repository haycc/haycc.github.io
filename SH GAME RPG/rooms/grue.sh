...
sleep 1
echo "This is a long room, and as you walk down it, you see a person."
echo "Finally! Another person! You start to run toward the shadowy figure"
echo "but then stop as fast as you can. This isn't... no... it can't be. It's... it's..."
echo "IT'S THE GRIM REAPER."
sleep 3
echo
echo "No. NO! You cry, as he sits you down and, rather than beating you to"
echo "death, starts to read you some of his Poetry. It's awful. Your"
...
echo "You start to feel dizzy. You can't think straight. As you fall to the"
            ...
            echo "to wonder why the thing didn't just kill you quickly like"
            echo "he is suposed to."
            echo
